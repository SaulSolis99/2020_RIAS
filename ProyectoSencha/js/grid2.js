...
Ext.onReady(function(){
	...
	Ext.create('Ext.grid.Panel', {
		title: 'Usuarios',
		headerPosition: 'bottom', //probar con y sin atributo
		store: Ext.data.StoreManager.lookup('datosStore'), //relación con almacenamiento
	...
	var agrega = function(btn) {
		i++;
        Ext.data.StoreManager.lookup('datosStore').add({
			id: i, nombre: 'otro', ape: 'otro2'
		})
    }
